...
public interface SemesterRepository extends JpaRepository<Semester, Long> {
    ...
    @Modifying
    @Query("UPDATE Semester s SET s.isCurrent = CASE WHEN :today BETWEEN s.startDate AND s.endDate THEN true ELSE false END")
    void syncAllSemesterStatuses(@Param("today") LocalDate today);
}
